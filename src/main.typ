...
All--atom membrane systems were, for fluid systems, constructed using the CHARMM--GUI membrane builder [*ref à mettre*]. Gel-like membranes were built by hand from a Slipid pre-equilibrated patch [*ref à slipid*]. Symmetric bilayers composed of 100 lipids per leaflet were generated under periodic boundary conditions, resulting in lamellar multilayer systems separated by aqueous slabs.
...
Coarse--grained membrane systems were constructed using the CHARMM–GUI MARTINI Maker [*REF*]. After construction, the systems were subjected to the standard equilibration protocol generated by CHARMM--GUI, consisting of successive energy minimization and restrained equilibration steps.
